...
- When doing rendering code changes, check if a visual test in `src/tests` exists and implement one. If a tests exists, you can you `--screenshot 5` to generate a screenshot after 5 frames of lifetime.
