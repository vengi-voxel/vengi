...
TEST_F(DBConditionTest, testDBCondition) {
	const DBCondition c1("field1", "value1", Comparator::Bigger);
...
TEST_F(DBConditionTest, testDBConditionMultiple) {
	const DBCondition c1("field1", "value1", Comparator::Bigger);
	const DBCondition c2("field2", "value2", Comparator::Equal);
...
TEST_F(DBConditionTest, testDBConditionMultipleStacked) {
	const DBCondition c1_1("field1", "value1", Comparator::Bigger);
	const DBCondition c1_2("field2", "value2", Comparator::Equal);
	DBConditionMultiple m1(true, {&c1_1, &c1_2});

	const DBCondition c2_1("field1", "value1", Comparator::Lesser);
	const DBCondition c2_2("field2", "value2", Comparator::BiggerOrEqual);
