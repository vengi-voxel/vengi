...
TEST_F(InventoryTest, testAdd) {
	...
	ASSERT_NE(nullptr, _inv.remove(_containerId, 1, 2)) << "Could not remove item from container 1, 2 - even though the item with a size of two should also occupy this field";
