...
PreferredSize RotPreferredSize(const PreferredSize &ps, AXIS axis) {
	...
	psr.size_dependency =
		((ps.size_dependency & SIZE_DEP_WIDTH_DEPEND_ON_HEIGHT) ? SIZE_DEP_HEIGHT_DEPEND_ON_WIDTH : SIZE_DEP_NONE) |
		((ps.size_dependency & SIZE_DEP_HEIGHT_DEPEND_ON_WIDTH) ? SIZE_DEP_WIDTH_DEPEND_ON_HEIGHT : SIZE_DEP_NONE);
	return psr;
}
