...
CORE_ENUM_BIT_OPERATIONS(MODIFIER_KEYS);

enum BUTTON_TYPE { TB_LEFT = 0, TB_RIGHT = 1, TB_MIDDLE = 2, TB_TOUCH = 4, TB_UNKNOWN = 8 };
CORE_ENUM_BIT_OPERATIONS(BUTTON_TYPE);
...
CORE_ENUM_BIT_OPERATIONS(WIDGET_STATE);
...
CORE_ENUM_BIT_OPERATIONS(WIDGET_GRAVITY);
...
CORE_ENUM_BIT_OPERATIONS(SIZE_DEP);
