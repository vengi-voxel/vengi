...
function arguments()
	return {
		...
		{ name = 'leavesColor', desc = 'Primary foliage color (red)', type = 'colorindex', default = '2' },
		{ name = 'leavesColor2', desc = 'Secondary foliage color (darker red)', type = 'colorindex', default = '3' },
