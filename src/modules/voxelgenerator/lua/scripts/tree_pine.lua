...
function main(node, region, color, trunkHeight, trunkStrength, leavesWidth, leavesHeight, leavesDepth, singleLeafHeight, singleStepDelta, startWidth, startDepth, trunkColor, leavesColor)
