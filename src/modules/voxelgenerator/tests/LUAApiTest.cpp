...
TEST_F(LUAApiTest, testTreeHawthorn) {
	scenegraph::SceneGraph sceneGraph;
	runFile(sceneGraph, "tree_hawthorn.lua");
}
...
TEST_F(LUAApiTest, testTreeAraucaria) {
	scenegraph::SceneGraph sceneGraph;
...
TEST_F(LUAApiTest, testTreeRedMaple) {
	scenegraph::SceneGraph sceneGraph;
	runFile(sceneGraph, "tree_redmaple.lua");
}

TEST_F(LUAApiTest, testTreeTulip) {
	scenegraph::SceneGraph sceneGraph;
	runFile(sceneGraph, "tree_tulip.lua");
}

TEST_F(LUAApiTest, testTreeButternut) {
	scenegraph::SceneGraph sceneGraph;
	runFile(sceneGraph, "tree_butternut.lua");
}

TEST_F(LUAApiTest, testTreeBalsamFir) {
	scenegraph::SceneGraph sceneGraph;
	runFile(sceneGraph, "tree_balsamfir.lua");
}

TEST_F(LUAApiTest, testTreeAmericanElm) {
	scenegraph::SceneGraph sceneGraph;
	runFile(sceneGraph, "tree_americanelm.lua");
}

TEST_F(LUAApiTest, testTreeAmericanBeech) {
	scenegraph::SceneGraph sceneGraph;
	runFile(sceneGraph, "tree_americanbeech.lua");
}
...
TEST_F(LUAApiTest, testColosseum) {
	scenegraph::SceneGraph sceneGraph;
	runFile(sceneGraph, "colosseum.lua");
}
