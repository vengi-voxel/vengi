...
private:
	...
	bool readLimb(io::SeekableReadStream& stream, vxl_mdl& mdl, uint32_t limbIdx, VoxelVolumes& volumes) const;
	bool readLimbs(io::SeekableReadStream& stream, vxl_mdl& mdl, VoxelVolumes& volumes) const;
