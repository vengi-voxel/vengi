...
TEST_F(ThingNodeParserTest, testParseNode) {
	...
	ASSERT_EQ(nodeSpec.color, core::RGBA(0xaa, 0xbb, 0xcc, 255));
	ASSERT_EQ(nodeSpec.modelName, "root.vox");
	ASSERT_EQ(nodeSpec.name, "root");
	ASSERT_VEC3_NEAR(nodeSpec.localPos, glm::vec3(0.0f, 0.0f, 0.0f), 0.000001f);
	ASSERT_VEC3_NEAR(nodeSpec.localRot, glm::vec3(0.0f, 180.0f, 0.0f), 0.000001f);
	...
	ASSERT_EQ(nodeSpec.children[0].color, core::RGBA(0xaa, 0, 0, 255));
	ASSERT_VEC3_NEAR(nodeSpec.children[0].localPos, glm::vec3(1.0f, 2.0f, 3.0f), 0.000001f);
	ASSERT_VEC3_NEAR(nodeSpec.children[0].localRot, glm::vec3(4.0f, 5.0f, 6.0f), 0.000001f);
	...
	ASSERT_EQ(nodeSpec.children[1].color, core::RGBA(0, 0xaa, 0, 255));
	ASSERT_VEC3_NEAR(nodeSpec.children[1].localPos, glm::vec3(7.0f, 8.0f, 9.0f), 0.000001f);
	ASSERT_VEC3_NEAR(nodeSpec.children[1].localRot, glm::vec3(10.0f, 11.0f, 12.0f), 0.000001f);
	...
	ASSERT_EQ(nodeSpec.children[2].color, core::RGBA(0, 0, 0xaa, 255));
	ASSERT_VEC3_NEAR(nodeSpec.children[2].localPos, glm::vec3(13.0f, 14.0f, 15.0f), 0.000001f);
	ASSERT_VEC3_NEAR(nodeSpec.children[2].localRot, glm::vec3(16.0f, 17.0f, 18.0f), 0.000001f);
