...
bool FormatConfig::init() {
	...
	const core::VarDef voxformatMergequads(cfg::VoxformatMergequads, true, core::CV_NOPERSIST, N_("Merge quads"), N_("Merge similar quads to optimize the mesh"));
	core::registerVar(voxformatMergequads);
	const core::VarDef voxformatMeshMode(cfg::VoxformatMeshMode, (int)voxel::SurfaceExtractionType::Binary,
				   (int)voxel::SurfaceExtractionType::Cubic, (int)voxel::SurfaceExtractionType::Max - 1,
				   core::CV_NOPERSIST,
				   N_("Mesh mode"),
	...
	const core::VarDef voxformatReusevertices(cfg::VoxformatReusevertices, true, core::CV_NOPERSIST,
				   N_("Reuse vertices"), N_("Reuse vertices or always create new ones"));
	...
	const core::VarDef voxformatAmbientocclusion(cfg::VoxformatAmbientocclusion, false, core::CV_NOPERSIST,
				   N_("Ambient occlusion"), N_("Extra vertices for ambient occlusion"));
	core::registerVar(voxformatAmbientocclusion);
	const core::VarDef voxformatRGBFlattenFactor(cfg::VoxformatRGBFlattenFactor, 0, 0, 255, core::CV_NOPERSIST,
				   N_("RGB flatten factor"), N_("The RGB color flatten factor for importing color and mesh formats"));
	core::registerVar(voxformatRGBFlattenFactor);
	const core::VarDef voxformatTargetColors(cfg::VoxformatTargetColors, 0, 0, 256, core::CV_NOPERSIST,
				   N_("Target colors (0=no limit)"),
	...
	const core::VarDef voxformatSaveVisibleOnly(cfg::VoxformatSaveVisibleOnly, false, core::CV_NOPERSIST, N_("Save visible only"), N_("Save only visible nodes"));
	core::registerVar(voxformatSaveVisibleOnly);
	const core::VarDef voxformatScale(cfg::VoxformatScale, 1.0f, core::CV_NOPERSIST,
				   N_("Uniform scale"), N_("Scale the vertices for voxelization on all axis by the given factor"));
	core::registerVar(voxformatScale);
	const core::VarDef voxformatScaleX(cfg::VoxformatScaleX, 1.0f, core::CV_NOPERSIST,
				   N_("X axis scale"), N_("Scale the vertices for voxelization X axis by the given factor"));
	core::registerVar(voxformatScaleX);
	const core::VarDef voxformatScaleY(cfg::VoxformatScaleY, 1.0f, core::CV_NOPERSIST,
				   N_("Y axis scale"), N_("Scale the vertices for voxelization Y axis by the given factor"));
	core::registerVar(voxformatScaleY);
	const core::VarDef voxformatScaleZ(cfg::VoxformatScaleZ, 1.0f, core::CV_NOPERSIST,
				   N_("Z axis scale"), N_("Scale the vertices for voxelization Z axis by the given factor"));
	core::registerVar(voxformatScaleZ);
	const core::VarDef voxformatQuads(cfg::VoxformatQuads, true, core::CV_NOPERSIST,
				   N_("Exports quads"), N_("Export as quads. If this false, triangles will be used."));
	core::registerVar(voxformatQuads);
	const core::VarDef voxformatWithColor(cfg::VoxformatWithColor, true, core::CV_NOPERSIST, N_("Vertex colors"), N_("Export with vertex colors"));
	...
	const core::VarDef voxformatWithNormals(cfg::VoxformatWithNormals, false, core::CV_NOPERSIST,
				   N_("Normals"), N_("Export smoothed normals for cubic meshes"));
	...
	const core::VarDef voxformatColorAsFloat(cfg::VoxformatColorAsFloat, true, core::CV_NOPERSIST,
				   N_("Vertex colors as float"), N_("Export with vertex colors as float values (if vertex colors are exported)"));
	...
	const core::VarDef voxformatWithtexcoords(cfg::VoxformatWithtexcoords, true, core::CV_NOPERSIST,
				   N_("Texture coordinates"), N_("Export with uv coordinates of the palette image"));
	...
	const core::VarDef voxformatTransform(cfg::VoxformatTransform, true, core::CV_NOPERSIST,
				   N_("Apply transformations"), N_("Apply the scene graph transform to mesh exports"));
	core::registerVar(voxformatTransform);
	const core::VarDef voxformatOptimize(cfg::VoxformatOptimize, false, core::CV_NOPERSIST, N_("Apply optimizations"), N_("Apply mesh optimization steps to meshes"));
	core::registerVar(voxformatOptimize);
	const core::VarDef voxformatFillHollow(cfg::VoxformatFillHollow, true, core::CV_NOPERSIST,
				   N_("Fill hollow"), N_("Fill the hollows when voxelizing a mesh format"));
	core::registerVar(voxformatFillHollow);
	const core::VarDef voxformatVoxelizeMode(cfg::VoxformatVoxelizeMode, MeshFormat::VoxelizeMode::HighQuality, 0, 1, core::CV_NOPERSIST,
	...
	const core::VarDef voxformatQBTPaletteMode(cfg::VoxformatQBTPaletteMode, true, core::CV_NOPERSIST,
				   N_("Palette mode"), N_("Use palette mode in qubicle qbt export"));
	...
	const core::VarDef voxformatQBTMergeCompounds(cfg::VoxformatQBTMergeCompounds, false, core::CV_NOPERSIST,
				   N_("Merge compounds"), NC_("Merge compounds when loading Qubicle QBT files", "Merge compounds on load"));
	core::registerVar(voxformatQBTMergeCompounds);
	const core::VarDef voxformatMerge(cfg::VoxformatMerge, false, core::CV_NOPERSIST, N_("Single object"), N_("Merge all objects into one"));
	core::registerVar(voxformatMerge);
	const core::VarDef voxformatEmptyPaletteIndex(cfg::VoxformatEmptyPaletteIndex, -1, -1, 255, core::CV_NOPERSIST,
				   N_("Empty palette index"), N_("The index of the empty color in the palette"));
	core::registerVar(voxformatEmptyPaletteIndex);
	const core::VarDef voxformatVXLLoadHVA(cfg::VoxformatVXLLoadHVA, true, core::CV_NOPERSIST, N_("Load HVA"), N_("Load the hva for animations"));
	...
	const core::VarDef voxformatVOXCreateGroups(cfg::VoxformatVOXCreateGroups, true, core::CV_NOPERSIST,
				   N_("Create groups"), NC_("Create groups when saving MagicaVoxel vox files", "Create groups for vox file"));
	...
	const core::VarDef voxformatVOXCreateLayers(cfg::VoxformatVOXCreateLayers, true, core::CV_NOPERSIST,
				   N_("Create layers"), NC_("Create layers when saving MagicaVoxel vox files", "Create layers for vox file"));
	...
	const core::VarDef voxformatQBSaveLeftHanded(cfg::VoxformatQBSaveLeftHanded, true, core::CV_NOPERSIST,
				   N_("Left handed"), N_("Toggle between left and right handed"));
	...
	const core::VarDef voxformatQBSaveCompressed(cfg::VoxformatQBSaveCompressed, true, core::CV_NOPERSIST,
				   N_("Compressed"), NC_("Save qubicle voxel files with RLE compression enabled", "Save RLE compressed"));
	...
	const core::VarDef voxformatPointCloudSize(cfg::VoxformatPointCloudSize, 1, core::CV_NOPERSIST,
				   N_("Point cloud size"), N_("Specify the side length for the voxels when loading a point cloud"));
	...
	const core::VarDef voxformatGLTF_KHR_materials_pbrSpecularGlossiness(cfg::VoxformatGLTF_KHR_materials_pbrSpecularGlossiness, true, core::CV_NOPERSIST,
				   N_("KHR_materials_pbrSpecularGlossiness"), N_("Apply KHR_materials_pbrSpecularGlossiness when saving into the glTF format"));
	...
	const core::VarDef voxformatGLTF_KHR_materials_specular(cfg::VoxformatGLTF_KHR_materials_specular, false, core::CV_NOPERSIST,
				   N_("KHR_materials_specular"), N_("Apply KHR_materials_specular when saving into the glTF format"));
	...
	const core::VarDef voxformatWithMaterials(cfg::VoxformatWithMaterials, true, core::CV_NOPERSIST,
				   N_("Export materials"), N_("Try to export material properties if the formats support it"));
	core::registerVar(voxformatWithMaterials);
	const core::VarDef voxformatImageVolumeMaxDepth(cfg::VoxformatImageVolumeMaxDepth, 1, 1, 255, core::CV_NOPERSIST,
				   N_("Max depth"),
				   N_("The maximum depth of the volume when importing an image as volume"));
	core::registerVar(voxformatImageVolumeMaxDepth);
	const core::VarDef voxformatImageHeightmapMinHeight(cfg::VoxformatImageHeightmapMinHeight, 0, 0, 255, core::CV_NOPERSIST,
				   N_("Min height"),
	...
	const core::VarDef voxformatImageVolumeBothSides(cfg::VoxformatImageVolumeBothSides, true, core::CV_NOPERSIST,
				   N_("Both sides"), N_("Import the image as volume for both sides"));
	...
	const core::VarDef voxformatTexturePath(cfg::VoxformatTexturePath, "", core::CV_NOPERSIST,
				   N_("Texture search path"), N_("Register an additional search path for texture lookups"));
	...
	const core::VarDef voxformatImageImportType(cfg::VoxformatImageImportType, PNGFormat::ImageType::Plane,
				   PNGFormat::ImageType::Plane, PNGFormat::ImageType::Volume, core::CV_NOPERSIST,
				   N_("Image import type"),
				   N_("0 = plane, 1 = heightmap, 2 = volume"));
	core::registerVar(voxformatImageImportType);
	const core::VarDef voxformatImageSaveType(cfg::VoxformatImageSaveType, PNGFormat::ImageType::Plane,
				   PNGFormat::ImageType::Plane, PNGFormat::ImageType::Volume, core::CV_NOPERSIST,
				   N_("Image save type"),
				   NC_("Image save type", "0 = plane, 1 = heightmap, 2 = volume, 3 = thumbnail"));
	core::registerVar(voxformatImageSaveType);
	const core::VarDef voxformatImageSliceOffsetAxis(cfg::VoxformatImageSliceOffsetAxis, "y", {"x", "y", "z"}, core::CV_NOPERSIST,
				   N_("Slice offset axis"),
	...
	const core::VarDef voxformatImageSliceOffset(cfg::VoxformatImageSliceOffset, 0, core::CV_NOPERSIST,
				   N_("Slice offset"), N_("The offset of the slices when importing images as volumes or heightmaps"));
	...
	const core::VarDef voxformatSchematicType(cfg::VoxformatSchematicType, "mcedit2", {"mcedit2", "worldedit", "schematica"}, core::CV_NOPERSIST,
				   N_("Schematic type"), N_("The type of schematic format to use when saving schematics"));
	core::registerVar(voxformatSchematicType);
	const core::VarDef voxformatBinvoxVersion(cfg::VoxformatBinvoxVersion, 2, 1, 3, core::CV_NOPERSIST,
				   N_("Binvox version"), NC_("Binvox format version", "Save in version 1, 2 or the unofficial version 3"));
	...
	const core::VarDef voxformatSkinApplyTransform(cfg::VoxformatSkinApplyTransform, false, core::CV_NOPERSIST,
				   N_("Apply transformations"), N_("Apply transforms to Minecraft skins"));
	...
	const core::VarDef voxformatSkinAddGroups(cfg::VoxformatSkinAddGroups, true, core::CV_NOPERSIST,
				   N_("Add groups"), N_("Add groups for body parts of Minecraft skins"));
	...
	const core::VarDef voxformatSkinMergeFaces(cfg::VoxformatSkinMergeFaces, false, core::CV_NOPERSIST,
				   N_("Merge faces"), N_("Merge face parts into single volume for Minecraft skins"));
	...
	const core::VarDef voxformatMeshSimplify(cfg::VoxformatMeshSimplify, false, core::CV_NOPERSIST,
				   N_("Simplify"), N_("Simplify the mesh when voxelizing a mesh format"));
	...
	const core::VarDef voxformatOSMMetersPerVoxel(cfg::VoxformatOSMMetersPerVoxel, 1.0f, core::CV_NOPERSIST,
				   N_("Meters per voxel"), N_("The number of real-world meters each voxel represents in OSM imports"));
