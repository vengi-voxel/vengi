...
static const BlockColor BLOCKCOLOR[]{
	...
	{ 93, core::RGBA(97, 111, 101, 50) }, // TERRAIN_GRASS_SPRITE
	{ 94, core::RGBA(135, 69, 57, 255) }, // PLAYER_SPAWN_MODULE
	{ 95, core::RGBA(144, 154, 85, 50) }, // TERRAIN_BROWNWEED_SPRITE
	{ 96, core::RGBA(160, 129, 119, 50) }, // TERRAIN_MARSTENTACLES_SPRITE
	{ 97, core::RGBA(59, 91, 130, 50) }, // TERRAIN_ALIENVINE_SPRITE
	{ 98, core::RGBA(63, 78, 34, 50) }, // TERRAIN_GRASSFLOWERS_SPRITE
	{ 99, core::RGBA(167, 156, 117, 50) }, // TERRAIN_LONGWEED_SPRITE
	{ 100, core::RGBA(177, 100, 68, 50) }, // TERRAIN_TALLSHROOM_SPRITE
	{ 101, core::RGBA(52, 76, 89, 50) }, // TERRAIN_PURSPIRE_SPRITE
	{ 102, core::RGBA(88, 98, 39, 50) }, // TERRAIN_TALLGRASSFLOWERS_SPRITE
	{ 103, core::RGBA(165, 132, 69, 50) }, // TERRAIN_MINICACTUS_SPRITE
	{ 104, core::RGBA(120, 69, 47, 50) }, // TERRAIN_REDSHROOM_SPRITE
	{ 105, core::RGBA(61, 78, 98, 50) }, // TERRAIN_PURPTACLES_SPRITE
	{ 106, core::RGBA(116, 108, 22, 50) }, // TERRAIN_TALLFLOWERS_SPRITE
	{ 107, core::RGBA(150, 114, 64, 50) }, // TERRAIN_ROCK_SPRITE
	{ 108, core::RGBA(165, 94, 58, 50) }, // TERRAIN_ALIENFLOWERS_SPRITE
	{ 109, core::RGBA(49, 43, 55, 50) }, // TERRAIN_YHOLE_SPRITE
	{ 142, core::RGBA(103, 102, 101, 50) }, // TERRAIN_M1L2_ID
	{ 143, core::RGBA(6, 73, 113, 255) }, // TERRAIN_M1L3_ID
	{ 144, core::RGBA(159, 169, 175, 50) }, // TERRAIN_M1L4_ID
	{ 145, core::RGBA(28, 93, 130, 255) }, // TERRAIN_M1L5_ID
	{ 146, core::RGBA(121, 112, 105, 50) }, // TERRAIN_M2L2_ID
	...
	{ 150, core::RGBA(108, 100, 96, 50) }, // TERRAIN_M3L2_ID
	{ 151, core::RGBA(131, 62, 30, 255) }, // TERRAIN_M3L3_ID
	{ 152, core::RGBA(182, 165, 157, 50) }, // TERRAIN_M3L4_ID
	{ 153, core::RGBA(135, 73, 45, 255) }, // TERRAIN_M3L5_ID
	{ 154, core::RGBA(109, 104, 97, 50) }, // TERRAIN_M4L2_ID
	{ 155, core::RGBA(117, 89, 43, 255) }, // TERRAIN_M4L3_ID
	{ 156, core::RGBA(186, 176, 162, 50) }, // TERRAIN_M4L4_ID
	{ 157, core::RGBA(156, 120, 71, 255) }, // TERRAIN_M4L5_ID
	{ 158, core::RGBA(103, 100, 97, 50) }, // TERRAIN_M5L2_ID
	{ 159, core::RGBA(102, 102, 102, 255) }, // TERRAIN_M5L3_ID
	{ 160, core::RGBA(127, 121, 117, 50) }, // TERRAIN_M5L4_ID
	{ 161, core::RGBA(167, 167, 167, 255) }, // TERRAIN_M5L5_ID
	{ 162, core::RGBA(105, 100, 102, 50) }, // TERRAIN_M6L2_ID
	{ 163, core::RGBA(58, 39, 82, 255) }, // TERRAIN_M6L3_ID
	{ 164, core::RGBA(142, 135, 141, 50) }, // TERRAIN_M6L4_ID
	{ 165, core::RGBA(54, 39, 79, 255) }, // TERRAIN_M6L5_ID
	{ 166, core::RGBA(117, 109, 104, 50) }, // TERRAIN_M7L2_ID
	...
	{ 170, core::RGBA(108, 99, 96, 50) }, // TERRAIN_M8L2_ID
	{ 171, core::RGBA(98, 36, 30, 255) }, // TERRAIN_M8L3_ID
	{ 172, core::RGBA(175, 159, 155, 50) }, // TERRAIN_M8L4_ID
	{ 173, core::RGBA(104, 43, 36, 255) }, // TERRAIN_M8L5_ID
	{ 174, core::RGBA(119, 111, 109, 50) }, // TERRAIN_M9L2_ID
	...
	{ 178, core::RGBA(105, 105, 97, 50) }, // TERRAIN_M10L2_ID
	{ 179, core::RGBA(42, 110, 63, 255) }, // TERRAIN_M10L3_ID
	{ 180, core::RGBA(165, 176, 165, 50) }, // TERRAIN_M10L4_ID
	{ 181, core::RGBA(55, 120, 77, 255) }, // TERRAIN_M10L5_ID
	{ 182, core::RGBA(122, 114, 106, 50) }, // TERRAIN_M11L2_ID
	...
	{ 186, core::RGBA(119, 114, 106, 50) }, // TERRAIN_M12L2_ID
	...
	{ 190, core::RGBA(118, 113, 109, 50) }, // TERRAIN_M13L2_ID
	...
	{ 194, core::RGBA(132, 123, 120, 50) }, // TERRAIN_M14L2_ID
	...
	{ 198, core::RGBA(119, 111, 107, 50) }, // TERRAIN_M15L2_ID
	...
	{ 202, core::RGBA(104, 100, 98, 50) }, // TERRAIN_M16L2_ID
	{ 203, core::RGBA(41, 41, 41, 255) }, // TERRAIN_M16L3_ID
	{ 204, core::RGBA(105, 101, 98, 50) }, // TERRAIN_M16L4_ID
	...
	{ 238, core::RGBA(87, 88, 84, 50) }, // MAN_SDPROTON
	{ 239, core::RGBA(82, 71, 95, 50) }, // MAN_RED
	{ 240, core::RGBA(80, 78, 93, 50) }, // MAN_PURP
	{ 241, core::RGBA(75, 71, 80, 50) }, // MAN_BROWN
	{ 242, core::RGBA(73, 89, 84, 50) }, // MAN_GREEN
	{ 243, core::RGBA(87, 92, 81, 50) }, // MAN_YELLOW
	{ 244, core::RGBA(78, 83, 87, 50) }, // MAN_BLACK
	{ 245, core::RGBA(120, 123, 125, 50) }, // MAN_WHITE
	{ 246, core::RGBA(76, 89, 96, 50) }, // MAN_BLUE
	...
	{ 278, core::RGBA(92, 130, 139, 50) }, // TERRAIN_ICEPLANET_SPIKE_SPRITE
	{ 279, core::RGBA(75, 113, 118, 50) }, // TERRAIN_ICEPLANET_ICECRAG_SPRITE
	{ 280, core::RGBA(132, 165, 168, 50) }, // TERRAIN_ICEPLANET_ICECORAL_SPRITE
	{ 281, core::RGBA(59, 109, 111, 50) }, // TERRAIN_ICEPLANET_ICEGRASS_SPRITE
	...
	{ 340, core::RGBA(81, 57, 59, 50) }, // LIGHT_BULB_YELLOW
	{ 341, core::RGBA(144, 140, 133, 50) }, // SPRITE_BRONZE
	{ 342, core::RGBA(155, 162, 162, 50) }, // SPRITE_SILVER
	{ 343, core::RGBA(96, 96, 93, 50) }, // SPRITE_GOLD
	...
	{ 411, core::RGBA(77, 75, 61, 50) }, // SIGNAL_TRIGGER_AREA
	...
	{ 440, core::RGBA(96, 96, 96, 94) }, // METAL_MESH
	{ 441, core::RGBA(96, 96, 96, 94) }, // METAL_MESH_WEDGE
	{ 442, core::RGBA(65, 65, 65, 138) }, // METAL_GRID
	{ 443, core::RGBA(65, 65, 65, 138) }, // METAL_GRD_WEDGE
	...
	{ 480, core::RGBA(189, 179, 115, 50) }, // RESS_CRYS_HATTEL
	{ 481, core::RGBA(189, 155, 117, 50) }, // RESS_CRYS_SINTYR
	{ 482, core::RGBA(190, 147, 134, 50) }, // RESS_CRYS_MATTISE
	{ 483, core::RGBA(144, 106, 183, 50) }, // RESS_CRYS_RAMMET
	{ 484, core::RGBA(138, 170, 188, 50) }, // RESS_CRYS_VARAT
	{ 485, core::RGBA(134, 177, 141, 50) }, // RESS_CRYS_BASTYN
	{ 486, core::RGBA(130, 122, 117, 50) }, // RESS_CRYS_PARSEN
	{ 487, core::RGBA(61, 44, 68, 50) }, // RESS_CRYS_NOCX
	{ 488, core::RGBA(75, 59, 23, 50) }, // RESS_ORE_THRENS
	{ 489, core::RGBA(63, 27, 11, 50) }, // RESS_ORE_JISPER
	{ 490, core::RGBA(86, 39, 37, 50) }, // RESS_ORE_ZERCANER
	{ 491, core::RGBA(37, 31, 63, 50) }, // RESS_ORE_SERTISE
	{ 492, core::RGBA(22, 48, 53, 50) }, // RESS_ORE_HITAL
	{ 493, core::RGBA(45, 69, 23, 50) }, // RESS_ORE_FERTIKEEN
	{ 494, core::RGBA(83, 89, 81, 50) }, // RESS_ORE_PARSTUN
	{ 495, core::RGBA(32, 27, 36, 50) }, // RESS_ORE_NACHT
	{ 496, core::RGBA(98, 61, 130, 255) }, // PURPLE_LIGHT
	{ 497, core::RGBA(135, 93, 57, 255) }, // ORANGE_LIGHT
	{ 498, core::RGBA(57, 64, 70, 255) }, // BLACK_LIGHT
	{ 499, core::RGBA(40, 40, 40, 50) }, // WHITE_POLE_LIGHT
	{ 500, core::RGBA(40, 40, 40, 50) }, // BLACK_POLE_LIGHT
	{ 501, core::RGBA(40, 41, 43, 50) }, // RED_POLE_LIGHT
	{ 502, core::RGBA(40, 40, 43, 50) }, // ORANGE_POLE_LIGHT
	{ 503, core::RGBA(40, 40, 40, 50) }, // YELLOW_POLE_LIGHT
	{ 504, core::RGBA(87, 82, 63, 50) }, // GREEN_POLE_LIGHT
	{ 505, core::RGBA(60, 77, 86, 50) }, // BLUE_POLE_LIGHT
	{ 506, core::RGBA(72, 74, 72, 50) }, // PURPLE_POLE_LIGHT
	...
	{ 546, core::RGBA(96, 96, 96, 94) }, // Scrap_Alloy
