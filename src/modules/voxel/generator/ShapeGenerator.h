...
public:
	...
	static void createCubeNoCenter(TerrainContext& ctx, const glm::ivec3& pos, int width, int height, int depth, const Voxel& voxel);
	static void createPlane(TerrainContext& ctx, const glm::ivec3& center, int width, int depth, const Voxel& voxel);
	static glm::ivec3 createL(TerrainContext& ctx, const glm::ivec3& pos, int width, int depth, int height, int thickness, const Voxel& voxel);
