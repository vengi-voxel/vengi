...
public:
	...
	static void expand(LSystemState* state, LSystemState* prevState, TerrainContext& terrainCtx, const LSystemContext& ctx, core::Random& random, char c, int generations);
