 ...
 */
extern bool executeCommandsForBinding(std::unordered_map<int32_t, int16_t>& keys, const util::BindMap& bindings, int32_t key, int16_t modifier, bool execute = true);
