 ...
 */
[[nodiscard]] core::DynamicArray<voxel::RawVolume *> splitVolume(const voxel::RawVolume *volume,
 ...
 */
[[nodiscard]] core::DynamicArray<voxel::RawVolume *> splitObjects(const voxel::RawVolume *v,
