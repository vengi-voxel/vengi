 ...
 */
extern voxel::RawVolume *rotateVolume(const voxel::RawVolume *source, const core::Optional<voxel::Palette> &palette,
									  const glm::vec3 &angles, const glm::vec3 &normalizedPivot);
/**
