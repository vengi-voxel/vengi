...
TEST_F(VolumeRotatorTest, testRotateAxisZ) {
	...
	EXPECT_EQ(voxel::VoxelType::Rock, rotated->voxel(0, 0, 0).getMaterial()) << *rotated;
	EXPECT_EQ(voxel::VoxelType::Grass, rotated->voxel(-1, 0, 0).getMaterial()) << *rotated;
	EXPECT_EQ(voxel::VoxelType::Dirt, rotated->voxel(0, 1, 0).getMaterial()) << *rotated;
	delete rotated;
}
...
TEST_F(VolumeRotatorTest, testRotateAxisY) {
	...
	ASSERT_NE(nullptr, rotated) << "No new volume was returned for the desired rotation";
	EXPECT_EQ(voxel::VoxelType::Rock, rotated->voxel(0, 0, 0).getMaterial()) << *rotated;
	EXPECT_EQ(voxel::VoxelType::Grass, rotated->voxel(0, 1, 0).getMaterial()) << *rotated;
	EXPECT_EQ(voxel::VoxelType::Dirt, rotated->voxel(0, 0, -1).getMaterial()) << *rotated;
	delete rotated;
}
...
TEST_F(VolumeRotatorTest, testRotateAxisX) {
	...
	ASSERT_NE(nullptr, rotated) << "No new volume was returned for the desired rotation";
	EXPECT_EQ(voxel::VoxelType::Rock, rotated->voxel(0, 0, 0).getMaterial()) << *rotated;
	EXPECT_EQ(voxel::VoxelType::Grass, rotated->voxel(0, 0, 1).getMaterial()) << *rotated;
	EXPECT_EQ(voxel::VoxelType::Dirt, rotated->voxel(1, 0, 0).getMaterial()) << *rotated;
	delete rotated;
}
