 ...
 * On Vulkan this builds the descriptor set layout. On GL/GLES this reconnects UBO block
 * bindings and sampler texture units (required when layout(binding) is stripped for ESSL).
 */
