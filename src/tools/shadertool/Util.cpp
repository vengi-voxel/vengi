...
static const Types cTypes[] = {
	...
	{ Variable::UVEC2,                 2,  2, 2, "glm::uvec2",   Reference, "uvec2" },
	{ Variable::UVEC3,                 3,  4, 3, "glm::uvec3",   Reference, "uvec3" },
	{ Variable::UVEC4,                 4,  4, 4, "glm::uvec4",   Reference, "uvec4" },
	{ Variable::IVEC2,                 2,  2, 2, "glm::ivec2",   Reference, "ivec2" },
	{ Variable::IVEC3,                 3,  4, 3, "glm::ivec3",   Reference, "ivec3" },
	{ Variable::IVEC4,                 4,  4, 4, "glm::ivec4",   Reference, "ivec4" },
	{ Variable::VEC2,                  2,  2, 2, "glm::vec2",    Reference, "vec2" },
	{ Variable::VEC3,                 3,  4, 3, "glm::vec3",    Reference, "vec3" },
	{ Variable::VEC4,                 4,  4, 4, "glm::vec4",    Reference, "vec4" },
	{ Variable::MAT4,                 16, 4, 1, "glm::mat4",    Reference, "mat4" },
