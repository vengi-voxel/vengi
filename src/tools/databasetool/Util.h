...
extern core::String getCPPType(persistence::FieldType type, bool function = false, bool pointer = false);
extern core::String getCPPInit(persistence::FieldType type, bool pointer);
