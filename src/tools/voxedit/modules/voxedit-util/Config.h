...
constexpr const char *VoxEditApplyGravity = "ve_applygravity";
constexpr const char *VoxEditJumpVelocity = "ve_jumpvelocity";
constexpr const char *VoxEditBodyHeight = "ve_bodyheight";
