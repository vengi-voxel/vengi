...
SceneStateMessage::SceneStateMessage(scenegraph::SceneGraph &sceneGraph) : ProtocolMessage(PROTO_SCENE_STATE) {
...
void SceneStateMessage::writeBack() {
