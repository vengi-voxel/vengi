...
bool SceneRenderer::init() {
	...
	const core::VarDef voxEditShadingMode(cfg::VoxEditShadingMode, 1, -1, N_("Shading mode"), N_("Shading mode: 0=Unlit, 1=Lit, 2=Shadows"));
	...
	const core::VarDef voxEditAmbientColor(cfg::VoxEditAmbientColor, "0.3 0.3 0.3", -1, N_("Ambient color"));
	_ambientColor = core::Var::registerVar(voxEditAmbientColor);
	const core::VarDef voxEditDiffuseColor(cfg::VoxEditDiffuseColor, "0.7 0.7 0.7", -1, N_("Diffuse color"));
	_diffuseColor = core::Var::registerVar(voxEditDiffuseColor);
	const core::VarDef voxEditSunAngle(cfg::VoxEditSunAngle, "35.0 135.0 0.0", -1, N_("Sun angle"), N_("pitch, yaw and ignored roll in degrees"));
