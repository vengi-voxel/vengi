...
int main(int argc, char *argv[]) {
	...
	const voxedit::SceneRendererPtr &sceneRenderer = core::make_shared<voxedit::SceneRenderer>(timeProvider);
	const voxedit::ModifierRendererPtr &modifierRenderer = core::make_shared<voxedit::ModifierRenderer>(timeProvider);
