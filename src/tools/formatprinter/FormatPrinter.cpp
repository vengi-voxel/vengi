...
void FormatPrinter::printManPage(const core::String &app) {
	...
	if (app == "thumbnailer") {
		...
		addManPageOption("--json", "Dump the scene graph of the input file. Use \\fBdefault\\fR, \\fBall\\fR, \\fBpalette\\fR, \\fBmeshdetails\\fR, \\fBnodedetails\\fR, \\fBchildren\\fR, \\fBpalettematerials\\fR, \\fBanimations\\fR as parameter to also print mesh details");
