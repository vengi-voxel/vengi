	...
	elseif(UNIX)
		if (_EXE_WINDOWED)
			...
			if (INSTALL_DATA)
				...
				if (EXISTS ${ROOT_DIR}/contrib/installer/linux/io.github.vengi-voxel.vengi.${_EXE_TARGET}.metainfo.xml)
					install(FILES ${ROOT_DIR}/contrib/installer/linux/io.github.vengi-voxel.vengi.${_EXE_TARGET}.metainfo.xml DESTINATION ${INSTALL_METAINFO_DIR} COMPONENT ${_EXE_TARGET})
				endif()
			endif()
		endif()
