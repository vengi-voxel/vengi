...
macro(generate_shaders TARGET)
	...
	generate_unity_sources(TARGET ${TARGET} SRCS ${_sources} UNITY_SRC "${CMAKE_CURRENT_BINARY_DIR}/${TARGET}_shaders_unity.cpp")
...
macro(gtest_suite_end name)
	if (UNITTESTS)
		...
		generate_unity_sources(TARGET ${name} SRCS ${srcs})
...
macro(engine_add_executable)
	...
	generate_unity_sources(TARGET ${_EXE_TARGET} SRCS ${_EXE_SRCS})
...
macro(engine_add_module)
	...
	generate_unity_sources(TARGET ${_LIB_TARGET} SRCS ${_LIB_SRCS})
