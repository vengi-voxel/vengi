...
function(engine_add_executable)
	...
	if (INSTALL_DATA)
		...
		cpack_add_component(${_EXE_TARGET} DISPLAY_NAME "${COMMANDLINE}" DESCRIPTION "${DESCRIPTION}" GROUP "${PROJECT_NAME}")
	endif()
...
function(engine_install_deps TARGET)
	...
	foreach (PO_FILE ${PO_FILES})
		configure_file(${DATA_DIR}/shared/${PO_FILE} ${CMAKE_BINARY_DIR}/${PROJECT_NAME}/${PO_FILE} COPYONLY)
	endforeach()
	...
	if (INSTALL_FILES)
		...
		foreach (PO_FILE ${PO_FILES})
			list(APPEND INSTALL_FILES shared/${PO_FILE})
		endforeach()
