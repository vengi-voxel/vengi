	...
	if (EXECUTABLE)
		...
		foreach (dep ${_LIBS_DEPENDENCIES})
			...
			foreach (luasrc ${LUA_SRCS})
				get_filename_component(luasrcdir ${luasrc} DIRECTORY)
				if (INSTALL_DATA)
					install(FILES ${LUA_SRCS_DIR}/lua/${luasrc} DESTINATION ${INSTALL_DATA_DIR}/${luasrcdir} COMPONENT ${_EXE_TARGET})
				endif()
				get_filename_component(filename ${luasrc} NAME)
				get_filename_component(datafiledir ${luasrc} DIRECTORY)
				configure_file(${LUA_SRCS_DIR}/lua/${luasrc} ${CMAKE_BINARY_DIR}/${_EXE_TARGET}/${datafiledir}/${filename} COPYONLY)
			endforeach()
		endforeach()
