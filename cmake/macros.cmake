...
function(engine_add_executable)
	...
	elseif(UNIX)
		...
		# TODO: extract the man page section from in file
		if (EXISTS ${ROOT_DIR}/contrib/installer/linux/${_EXE_TARGET}.man.in)
			configure_file(${ROOT_DIR}/contrib/installer/linux/${_EXE_TARGET}.man.in ${PROJECT_BINARY_DIR}/${CMAKE_PROJECT_NAME}-${_EXE_TARGET}.1)
			if (INSTALL_DATA)
				install(FILES ${PROJECT_BINARY_DIR}/${CMAKE_PROJECT_NAME}-${_EXE_TARGET}.1 DESTINATION share/man/man1 COMPONENT ${_EXE_TARGET})
			endif()
		endif()
	endif()
