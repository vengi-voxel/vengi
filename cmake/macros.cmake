...
macro(engine_add_module)
	...
	message(STATUS "Module ${_LIB_TARGET} initialized")
	set_property(GLOBAL PROPERTY ${_LIB_TARGET}_INITIALIZED True)
...
macro(engine_install_deps TARGET)
...
macro(engine_resolve_deps_recursive TARGET)
	...
	foreach (dep ${DEP_DEPENDENCIES})
		...
		if (${already_visited} EQUAL -1)
			get_property(DEP_INITIALIZED GLOBAL PROPERTY ${dep}_INITIALIZED)
			if (NOT ${DEP_INITIALIZED})
				message(FATAL_ERROR "${TARGET}: ${dep} not yet initialized")
			endif()
