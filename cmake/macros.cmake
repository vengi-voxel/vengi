...
function(engine_add_executable)
	...
	if (APPLE)
		set_target_properties(${_EXE_TARGET} PROPERTIES MACOSX_BUNDLE_INFO_PLIST ${ROOT_DIR}/contrib/installer/osx/application.plist.in)
		...
		if (INSTALL_DATA)
			install(CODE "include(BundleUtilities)
				fixup_bundle(\"$<TARGET_BUNDLE_DIR:${_EXE_TARGET}>\" \"\" \"\")" COMPONENT ${_EXE_TARGET})
		endif()
	elseif(WIN32)
	...
	elseif(UNIX)
		if (_EXE_WINDOWED)
			...
			if (INSTALL_DATA)
				...
				install(FILES ${ROOT_DIR}/contrib/installer/linux/io.github.vengi-voxel.vengi.voxedit.metainfo.xml DESTINATION ${INSTALL_METAINFO_DIR} COMPONENT ${_EXE_TARGET})
			endif()
		endif()
