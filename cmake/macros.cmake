...
function(engine_add_executable)
	...
	elseif (EMSCRIPTEN)
		if (EXISTS ${CMAKE_CURRENT_SOURCE_DIR}/${_EXE_TARGET}.html)
			...
			# Shared helpers for convert-tool shell UIs (optional @CONVERT_FILE_FILTER_JS@ placeholder)
			file(READ ${ROOT_DIR}/contrib/installer/emscripten/convert-file-filter.js CONVERT_FILE_FILTER_JS)
			configure_file(${CMAKE_CURRENT_SOURCE_DIR}/${_EXE_TARGET}.html ${CMAKE_CURRENT_BINARY_DIR}/${_EXE_TARGET}.shell.html @ONLY)
