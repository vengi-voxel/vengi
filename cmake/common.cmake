...
set(CMAKE_EXE_LINKER_FLAGS_DEBUG "${CMAKE_EXE_LINKER_FLAGS_DEBUG} -sDEMANGLE_SUPPORT=1 -sASSERTIONS=1 -sSAFE_HEAP=1 -sSAFE_HEAP_LOG=1")
set(CMAKE_EXE_LINKER_FLAGS_RELEASE "${CMAKE_EXE_LINKER_FLAGS_RELEASE} -sASSERTIONS=0")
set(CMAKE_EXE_LINKER_FLAGS "${CMAKE_EXE_LINKER_FLAGS} -sSTACK_SIZE=1048576 -sFULL_ES3=1 -sUSE_PTHREADS=1 -sWASM=1 -sUSE_SDL=2 -sINITIAL_MEMORY=384mb -sMAXIMUM_MEMORY=4gb -sALLOW_MEMORY_GROWTH=1 -sPTHREAD_POOL_SIZE=4 -sEXPORTED_FUNCTIONS=_main -sEXPORTED_RUNTIME_METHODS=[ccall] -sENVIRONMENT=web,worker -lidbfs.js")
set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -pthread -Os")
