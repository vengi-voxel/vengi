...
server client voxedit shapetool worldrenderertool shadertool noisetool databasetool uitool tests tests-core testmesh testcamera testdepthbuffer testtexture testvoxelfont testplane flatc: cmake
	$(call COMPILE, $@)
