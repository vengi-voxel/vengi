...
server client voxedit shapetool worldrenderertool shadertool noisetool noisetool2 databasetool uitool tests tests-core tests-voxel benchmarks-voxel tests-noise testmesh testcamera testdepthbuffer testtexture testvoxelfont testplane testimgui testoctree testoctreevisit testshapebuilder flatc computeshadertool: cmake
	$(call COMPILE, $@)
