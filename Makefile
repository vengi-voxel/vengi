...
server client voxedit shapetool worldrenderertool shadertool noisetool noisetool2 databasetool uitool tests tests-core testmesh testcamera testdepthbuffer testtexture testvoxelfont testplane testimgui flatc: cmake
	$(call COMPILE, $@)
